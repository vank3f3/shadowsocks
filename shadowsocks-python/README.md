## Shadowsocks-Python Docker Image by vank3f3
...
```bash
$ docker pull vank3f3/shadowsocks:python
```
...
```bash
$ docker run -d -p 9000:9000 -p 9000:9000/udp --name ss -v /etc/shadowsocks-python:/etc/shadowsocks-python vank3f3/shadowsocks:python
```
