## ShadowsocksR Docker Image by vank3f3
...
```bash
$ docker pull vank3f3/shadowsocks:r
```

or pull image based **alpine**

```bash
$ docker pull vank3f3/shadowsocks:r-alpine
```
...
```bash
$ docker run -d -p 9000:9000 -p 9000:9000/udp --name ssr -v /etc/shadowsocks-r:/etc/shadowsocks-r vank3f3/shadowsocks:r
```

There is an example to start a container based **alpine** that listens on `9000` (both TCP and UDP):

```bash
$ docker run -d -p 9000:9000 -p 9000:9000/udp --name ssr -v /etc/shadowsocks-r:/etc/shadowsocks-r vank3f3/shadowsocks:r-alpine
```
